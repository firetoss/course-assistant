...
def doc_import(session: SessionDep) -> Message:
    ...
    # exercies = ExcrciseImporter.parse_doc(
    #     f"app/exercise-original/{exercise_type}.docx", exercise_type
    # )
    ...
    #     exercie_in.options = (
    #         "[]"
    #         if exercise_type == "code-python"
    #         else json.dumps(item["options"], ensure_ascii=False)
    #     )
